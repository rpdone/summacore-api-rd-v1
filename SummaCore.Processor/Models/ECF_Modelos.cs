...
namespace SummaCore.Models
{
    ...
    public class ECF
    {
        ...
        [XmlElement(Order = 2)] public DetallesItems DetallesItems { get; set; } = new DetallesItems();
        ...
        [XmlElement(Order = 99)] public Signature Signature { get; set; } = new Signature();
    ...
    public class Encabezado
    {
        ...
        [XmlElement(Order = 8)] public string? CodigoSeguridadeCF { get; set; }
        [XmlElement(Order = 9)] public OtraMoneda OtraMoneda { get; set; }

        public bool ShouldSerializeComprador() => Comprador != null && 
            (!string.IsNullOrEmpty(Comprador.RNCComprador) || !string.IsNullOrEmpty(Comprador.IdentificadorExtranjero));
    ...
    public class IdDoc
    {
        ...
        {
            get => _tipoIngresos;
            set => _tipoIngresos = (value == "#e" || value == "0" || string.IsNullOrEmpty(value)) ? "" : value.PadLeft(2, '0');
        }
        ...
        public bool ShouldSerializeIndicadorEnvioDiferido() => TipoeCF != 34 && IndicadorEnvioDiferido.HasValue && IndicadorEnvioDiferido == 1;
        public bool ShouldSerializeIndicadorMontoGravado() => TipoeCF != 34 && TipoeCF < 41 && IndicadorMontoGravado.HasValue;
        public bool ShouldSerializeIndicadorServicioTodoIncluido() => TipoeCF != 34 && IndicadorServicioTodoIncluido.HasValue && IndicadorServicioTodoIncluido == 1;
        public bool ShouldSerializeTipoIngresos() => TipoeCF != 34 && !string.IsNullOrEmpty(_tipoIngresos);
        public bool ShouldSerializeTipoPago() => TipoeCF != 34 && TipoPago.HasValue && TipoPago > 0;
    ...
    public class Emisor {
        ...
        public List<string> TablaTelefonoEmisor { get; set; } = new List<string>();
        ...
        public bool ShouldSerializeMunicipio() => !string.IsNullOrEmpty(Municipio);
        public bool ShouldSerializeProvincia() => !string.IsNullOrEmpty(Provincia);
        public bool ShouldSerializeWebSite() => !string.IsNullOrEmpty(WebSite) && WebSite != "#e";
        public bool ShouldSerializeCorreoEmisor() => !string.IsNullOrEmpty(CorreoEmisor);
    ...
    public class Totales
    {
        ...
        [XmlElement(Order = 6)] public decimal? TotalITBIS { get; set; }
        [XmlElement(Order = 7)] public decimal? TotalITBIS1 { get; set; }
        [XmlElement(Order = 8)] public decimal? TotalITBIS2 { get; set; }
        [XmlElement(Order = 9)] public decimal? TotalITBIS3 { get; set; }
        [XmlElement(Order = 10)] public decimal? MontoImpuestoAdicional { get; set; }
        
        [XmlArray(Order = 11)]
        [XmlArrayItem("ImpuestoAdicional")]
        public List<ImpuestoAdicional> ImpuestosAdicionales { get; set; } = new List<ImpuestoAdicional>();

        [XmlElement(Order = 12)] public decimal MontoTotal { get; set; }
        [XmlElement(Order = 13)] public decimal? MontoNoFacturable { get; set; }
        [XmlElement(Order = 14)] public decimal? MontoPeriodo { get; set; }
        [XmlElement(Order = 15)] public decimal? SaldoAnterior { get; set; }
        [XmlElement(Order = 16)] public decimal? MontoAvancePago { get; set; }
        [XmlElement(Order = 17)] public decimal? ValorPagar { get; set; }
        [XmlElement(Order = 18)] public decimal? MontoRetencionRenta { get; set; }
        [XmlElement(Order = 19)] public decimal? MontoRetencionITBIS { get; set; }
        [XmlElement(Order = 20)] public decimal? TotalISRRetencion { get; set; }
    ...
    public class Item
    {
        ...
        [XmlElement(Order = 19)] public decimal? RecargoMonto { get; set; }
        [XmlElement(Order = 20)] public OtraMonedaDetalle OtraMonedaDetalle { get; set; }
        [XmlElement(Order = 21)] public decimal MontoItem { get; set; }
        ...
        public bool ShouldSerializeTablaSubDescuento() => TablaSubDescuento != null && TablaSubDescuento.Any();
    ...
    public class Subtotal
    {
        ...
        [XmlElement("SubTotalITBIS", Order = 8)] public decimal? SubTotalITBIS { get; set; }
        [XmlElement("SubTotalITBIS1", Order = 9)] public decimal? SubTotalITBIS1 { get; set; }
        [XmlElement("SubTotalITBIS2", Order = 10)] public decimal? SubTotalITBIS2 { get; set; }
        [XmlElement("SubTotalITBIS3", Order = 11)] public decimal? SubTotalITBIS3 { get; set; }
    ...
    public class SubDescuento
    {
        ...
        public bool ShouldSerializeMontoSubDescuento() => MontoSubDescuento.HasValue;
    }

    public class InformacionesAdicionales { 
        [XmlIgnore] public int TipoeCF_Context { get; set; }
        ...
        public bool ShouldSerializeTotalFob() => TotalFob.HasValue && TipoeCF_Context == 46; 
        public bool ShouldSerializeSeguro() => Seguro.HasValue && TipoeCF_Context == 46;
        public bool ShouldSerializeFlete() => Flete.HasValue && TipoeCF_Context == 46;
        public bool ShouldSerializeOtrosGastos() => OtrosGastos.HasValue && TipoeCF_Context == 46;
        public bool ShouldSerializeTotalCif() => TotalCif.HasValue && TipoeCF_Context == 46;
        public bool ShouldSerializeRegimenAduanero() => !string.IsNullOrEmpty(RegimenAduanero) && TipoeCF_Context == 46;
    }
    ...
    { 
        [XmlElement(Order = 1)] public int IndicadorAgenteRetencionoPercepcion { get; set; } 
        
        [XmlIgnore] public decimal MontoISRRetenido { get; set; } 
        
        [XmlElement("MontoISRRetenido", Order = 2)] 
        public string MontoISRRetenidoString 
        { 
            get => MontoISRRetenido.ToString("F2", CultureInfo.InvariantCulture); 
            set => MontoISRRetenido = decimal.TryParse(value, NumberStyles.Any, CultureInfo.InvariantCulture, out var d) ? d : 0; 
        } 
        
        public bool ShouldSerializeMontoISRRetenidoString() => true; 

        [XmlElement(Order = 3)] public decimal? MontoITBISRetenido { get; set; }
        
        public bool ShouldSerializeMontoITBISRetenido() => MontoITBISRetenido.HasValue && MontoITBISRetenido > 0;
    }
    ...
    public class InformacionReferencia { [XmlElement(Order = 1)] public string? NCFModificado { get; set; } [XmlElement(Order = 2)] public string? RNCOtroContribuyente { get; set; } [XmlElement(Order = 3)] public string? FechaNCFModificado { get; set; } [XmlElement(Order = 4)] public int? CodigoModificacion { get; set; } }
    public class TablaAdicional { [XmlElement(Order = 1)] public int TipoAdicional { get; set; } }
    public class OtraMoneda { [XmlElement(Order = 1)] public string? TipoMoneda { get; set; } [XmlElement(Order = 2)] public decimal? TipoCambio { get; set; } }
    public class Transporte { [XmlElement(Order = 1)] public string? Conductor { get; set; } }
    public class VersionType { [XmlText] public string Value { get; set; } = "1.0"; }
    public class ImpuestoAdicional { [XmlElement(Order = 1)] public string TipoImpuesto { get; set; } = ""; [XmlElement(Order = 2)] public decimal TasaImpuestoAdicional { get; set; } }
    ...
    public class CanonicalizationMethod { [XmlAttribute] public string Algorithm { get; set; } }
    public class SignatureMethod { [XmlAttribute] public string Algorithm { get; set; } }
    ...
    public class Transform { [XmlAttribute] public string Algorithm { get; set; } }
    public class DigestMethod { [XmlAttribute] public string Algorithm { get; set; } }
